function vMax = criticalVelocity(curvature)

%% Information
    % This function returns the critical velocity of the Simulink 14DOF
    ...
    %% Vehicle data (14DOF model)

g = 9.81;                       %% gravitational acceleration m/s^2

mVehicle = 1181;                %% Mass of the entire vehicle
...
wf = 1.5150;                    %%Front axle position from CG
wr = 1.5040;                    %%Rear axle position from CG

b = 1.9220;                     %%Track width

h = 0.1340;                      %%Centre of gravity

mu = 1;                         %%Static friction 

maxVel = 48 ;                   %%Maximum velocity achievable by the model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
