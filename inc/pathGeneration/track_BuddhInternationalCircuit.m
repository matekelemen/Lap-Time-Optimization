function track = track_BuddhInternationalCircuit(varargin)
    ...
    % Read the gpx files
    hhIn=gpxread('inc/track_from_gpx_file/Sample Tracks/Buddh_International_Circuit/Buddh_International_Circuit_Bound1.gpx');
    hhOut=gpxread('inc/track_from_gpx_file/Sample Tracks/Buddh_International_Circuit/Buddh_International_Circuit_Bound2.gpx');
