function track = track_CircuitoDoEstoril(varargin)
    ...
    % Read the gpx files
    hhIn=gpxread('inc/track_from_gpx_file/Sample Tracks/Circuito_do_Estoril/Circuito_do_Estoril_Bound1.gpx');
    hhOut=gpxread('inc/track_from_gpx_file/Sample Tracks/Circuito_do_Estoril/Circuito_do_Estoril_Bound2.gpx');
