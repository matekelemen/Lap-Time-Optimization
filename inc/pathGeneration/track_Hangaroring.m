function track = track_Nurburgring(varargin)
    ...
    % Read the gpx files
    hhIn=gpxread('inc/track_from_gpx_file/Sample Tracks/Hangaroring/Hangaroring_Bound1.gpx');
    hhOut=gpxread('inc/track_from_gpx_file/Sample Tracks/Hangaroring/Hangaroring_Bound2.gpx');
