function track = track_Hockenheimring(varargin)
    ...
    % Read the gpx files
    hhIn=gpxread('inc/track_from_gpx_file/Sample Tracks/Hockenheimring/Hockenheimring_inner.gpx');
    hhOut=gpxread('inc/track_from_gpx_file/Sample Tracks/Hockenheimring/Hockenheimring_outer.gpx');
    ...
    track.staticPoints  = [1,10,32,54,75,105,134,161,178,190,213,       ...
                           236,270,283,length(track.bound1)];
